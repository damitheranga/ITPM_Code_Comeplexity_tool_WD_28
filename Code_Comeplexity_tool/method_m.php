...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="size_c.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>SIZE</a> 
    ...
    <a href="method_m.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>METHODS</a>
...
<?php
   ...
   $contents = file_get_contents($file_store);
   /* $c = 0;
 ...
 echo $b;*/
    ...
    // Loop through our array, show HTML source as HTML source; and line numbers too.
      ...
      echo " <table id='pdfx' class = 'datatable' ><table width='2000'>";
      echo "<tr>
    <th>Line Number</th>
