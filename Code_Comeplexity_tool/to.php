...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="variable_change.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>VARIABLE</a> 
...
?>
 ...
 echo $b;*/
   ...
   foreach ($l as $line_num => $line) {
      ...
      echo $line."<br />  <td width='400' bgcolor=' #ffffe6'>"; echo  $_SESSION["cs"]."</td>
