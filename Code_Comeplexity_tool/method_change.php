...
$sql = "SELECT * FROM methodweigths ORDER BY m_id DESC LIMIT 1";
    ...
    if(mysqli_num_rows($result) > 0){
        echo "<table class='table table-hover'>";
            echo "<tr>";
                ...
                echo "<th scope='col'>Primitive return type</th>";
                echo "<th scope='col'>Composite return type</th>";
                echo "<th scope='col'>'void' return type</th>";
                echo "<th scope='col'>Primitive parameters</th>";
                echo "<th scope='col'>Composite parameters</th>";
            
            echo "</tr>";
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
                echo "<th scope='col'>Weight</th>";
                echo "<td>" . $row['p_return_type'] . "</td>";
                echo "<td>" . $row['c_return_type'] . "</td>";
                echo "<td>" . $row['v_return_type'] . "</td>";
                echo "<td>" . $row['p_para'] . "</td>";
                echo "<td>" . $row['c_para'] . "</td>";

                $w_pr_method = $row['p_return_type'];
                $w_co_method = $row['c_return_type'];
                $w_method = $row['v_return_type'];
