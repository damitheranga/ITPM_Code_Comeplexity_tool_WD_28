...
<head>
    <title>Upload View & Download file in PHP | Demo</title>
    <meta charset="UTF-8">
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
<meta content="width=device-width, initial-scale=1.0" name="viewport" >
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td><a href="upload/<?php echo $row['filename']; ?>" download>Download</td>
                      ...
                      <td>           <!-- Split button -->
                      <div class="btn-group">
                        <button type="button" class="btn btn-primary">Calculte</button>
                        <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <span class="sr-only">Toggle Dropdown</span>
                        </button>
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="size.php">Size</a>
                          <a class="dropdown-item" href="variable.php">Varaible</a>
                          <a class="dropdown-item" href="viewfile.php">Method</a>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="viewfile_INHERITANCE.php">Inheitance</a>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="Couplingdefult.php">Coupling</a>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="avi.php">Control Structures</a>
