...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <a href="size.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>SIZE</a> 
    ...
    <a href="total.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>TOTAL FACTORS</a>
...
<?php
            ...
            $sql = "SELECT s.*,v.*
            FROM   size s , variable v
            WHERE  s.line_num=v.line_num and s.id BETWEEN 1 AND 84";
...
;
            ...
            if($result = mysqli_query($link, $sql)){
                if(mysqli_num_rows($result) > 0){
                    echo "<table class= 'table-warning'>";
                        echo "<tr>";
                            
                            echo "<th>No</th>";
                            echo "<th  class='text-center''>Line</th>";
                            echo "<th>cs</th>";
                            echo "<th>cv</th>";
                            echo "<th>cm</th>";
