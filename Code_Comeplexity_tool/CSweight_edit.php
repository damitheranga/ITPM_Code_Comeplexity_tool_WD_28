<?php
    if(isset($_REQUEST['submit_btn']))
    {
      include_once 'db.php';
          ...
          $conditionalCS = mysqli_real_escape_string($link, $_REQUEST['conditionalCS']);
          $iterativeCS = mysqli_real_escape_string($link, $_REQUEST['iterativeCS']);
          $switchCS = mysqli_real_escape_string($link, $_REQUEST['switchCS']);
          $caseCS = mysqli_real_escape_string($link, $_REQUEST['caseCS']);
         
          
          // Attempt insert query execution
          $sql = "INSERT INTO csweight(conditionalCS, iterativeCS, switchCS,caseCS) VALUES ('$conditionalCS', '$iterativeCS', '$switchCS', '$caseCS')";
        

          if(mysqli_query($link, $sql)){
            echo '<script language="javascript">';
            echo 'alert("Successfully Added"); location.href="CSweight_edit.php"';
            echo '</script>';
...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="portfolio">
    ...
    <div class="w3-section w3-bottombar w3-padding-16">
        <form>
            ...
            <input class="btn btn-warning" type="button" value="Updated Weights" onclick="window.location.href='CS_change.php'" />
        </form>
  ...
  <div class="w3-row-padding">
    <div class="w3-third">
      <h4>Edit Weights of a program due to Control Structure</h4>
      <style>
      #customers {
...
<form action="" method="post">
  <div class="form-row">
    <div class="col-md-6 mb-3">
      <label for="validationDefault01">Conditional control structure</label>
      <input type="number" class="form-control" name="conditionalCS" id="validationDefault01" placeholder="Weight keyword" value="1" required>
    </div>
    <div class="col-md-6 mb-3">
      <label for="validationDefault02">An Iterative control structure</label>
      <input type="number" class="form-control" name="iterativeCS" id="validationDefault02" placeholder="Weight identifier" value="1" required>
    </div>
    <div class="col-md-6 mb-3">
      <label for="validationDefault02">‘switch’ statement</label>
      <input type="number" class="form-control" name="switchCS" id="validationDefault03" placeholder="Weight operator" value="1" required>
    </div>
    <div class="col-md-6 mb-3">
      <label for="validationDefault02">‘case’ statement</label>
      <input type="number" class="form-control" name="caseCS" id="validationDefault04" placeholder="Weight numerical value" value="1" required>
    </div>
  </div>
  <div class="form-row">
