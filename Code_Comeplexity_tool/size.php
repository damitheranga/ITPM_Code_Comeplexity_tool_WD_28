...
?>
    ...
    <td width='400' bgcolor=' #ffffe6'>"; echo $i_count."</td> <td width='400' bgcolor=' #ffffe6'>"; echo $op_count."</td><td width='400' bgcolor=' #ffffe6'>"; echo $n_count."</td><td width='400' bgcolor=' #ffffe6'>"; echo $str_count."</td><td width='400' bgcolor=' #ffffe6'>"; echo $cs."</td>";
      echo "</td></tr>";
