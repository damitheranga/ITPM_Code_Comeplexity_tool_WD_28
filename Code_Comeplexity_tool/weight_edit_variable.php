<?php
    if(isset($_REQUEST['submit_btn']))
    {
          ...
          $g_variables = mysqli_real_escape_string($link, $_REQUEST['g_variables']);
          $l_variables = mysqli_real_escape_string($link, $_REQUEST['l_variables']);
          $p_data_types = mysqli_real_escape_string($link, $_REQUEST['p_data_types']);
          $c_data_types = mysqli_real_escape_string($link, $_REQUEST['c_data_types']);
          
          
          // Attempt insert query execution
          $sql = "INSERT INTO variableweigths(g_variables, l_variables, p_data_types,c_data_types) VALUES ('$g_variables', '$l_variables', '$p_data_types', '$c_data_types')";
        

          if(mysqli_query($link, $sql)){
            echo '<script language="javascript">';
            echo 'alert("Successfully Added"); location.href="variable_change.php"';
            echo '</script>';
           echo '<script language="javascript">';
            echo 'alert("Successfully Added"); location.href="weight_edit_variable.php"';
            echo '</script>';
          } else{
...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="portfolio">
    ...
    <div class="w3-section w3-bottombar w3-padding-16">
        <form>
            ...
            <input class="btn btn-warning" type="button" value="Updated Weights" onclick="window.location.href='variable_chage.php'" />
        </form>
  ...
  <div class="w3-row-padding">
    <div class="w3-third">
      <h4>Edit Weights of a program due to variable</h4>
      <style>
      #customers {
...
<form>
  <div class="form-row">
    <div class="col-md-6 mb-3">
      <label for="validationDefault01">Global variables</label>
      <input type="number" class="form-control" name="g_variables" id="validationDefault01" placeholder="Weight Global variables" value="2" required>
    </div>
    <div class="col-md-6 mb-3">
      <label for="validationDefault02">Local variables</label>
      <input type="number" class="form-control" name="l_variables" id="validationDefault02" placeholder="Weight Local variables" value="1" required>
    </div>
    <div class="col-md-6 mb-3">
      <label for="validationDefault02">Primitive data type variables</label>
      <input type="number" class="form-control" name="p_data_types" id="validationDefault03" placeholder="Weight Primitive data type" value="1" required>
    </div>
    <div class="col-md-6 mb-3">
      <label for="validationDefault02">Composite data type variables</label>
      <input type="number" class="form-control" name="c_data_types" id="validationDefault04" placeholder="Weight Composite data type" value="2" required>
    </div>
