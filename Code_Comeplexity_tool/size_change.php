    ...
    if(mysqli_num_rows($result) > 0){
        echo "<table class='table table-hover'>";
            echo "<tr>";
                ...
                echo "<th scope='col'>identifier</th>";
                echo "<th scope='col'>operator</th>";
                echo "<th scope='col'>num_value</th>";
                echo "<th scope='col'>string_value</th>";
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
                ...
                $w_keyword =  $row['keyword'];
                $w_idi = $row['identifier'];
                $w_ope = $row['operator'];
                $w_str = $row['string_value'];
                $w_num =$row['num_value'];
...
?>
    ...
    "volatile","while");
     ...
     $ideintifiers = array("main", "float", "char", "boolean", "for","while", "do-while","if", "switch", "case","java","applet", "implements", "MouseListener","MouseMotionListener","ComponentListener");
        ...
        foreach ( $str_words as $str ) 
          {
            ...
            $_SESSION["cs"] = $k_count*$w_keyword + $i_count * $w_idi + $op_count * $w_ope+ $str_count * $w_str + $n_count * $w_num;
            ...
            echo "<tr><td width='100' bgcolor=' #ffffe6' > $line_num</td><td width='1300' bgcolor=' #ffffe6'>";
      echo $line."<br />  <td width='400' bgcolor=' #ffffe6'>"; echo $k_count."</td>
    <td width='400' bgcolor=' #ffffe6'>"; echo $i_count."</td> <td width='400' bgcolor=' #ffffe6'>"; echo $op_count."</td><td width='400' bgcolor=' #ffffe6'>"; echo $n_count."</td><td width='400' bgcolor=' #ffffe6'>"; echo $str_count."</td><td width='400' bgcolor=' #ffffe6'>"; echo $_SESSION["cs"]."</td>";
      echo "</td></tr>";
